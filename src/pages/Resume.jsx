        ...
        <>
            <div className='bg-[#fffafa]'>
                <div className='height px-2 py-3'>
                    <img src="/images/new-resume.jpg" className='h-100 mx-auto  resume-shadow my-resume' alt="" data-aos="zoom-in" />
                </div>
                <div className='position-fixed bottom-7 right-4'>
                    <a href="/images/darshit-resume.pdf" download="darshit_resume">
