    ...
    return (
        <>
            ...
            <div className='w-100 flex px-3 gap-3 flex-wrap my-4 justify-center items-center' data-aos="fade">
                ...
                <a href="#javascript" className='py-2 px-3 text-[#fff] bg-[#3d4c53]'>JavaScript</a>
                <a href="#react" className='py-2 px-3 text-[#fff] bg-[#3d4c53]'>React js</a>
                <a href="#redux" className='py-2 px-3 text-[#fff] bg-[#3d4c53]'>Redux</a>
                <a href="#git&github" className='py-2 px-3 text-[#fff] bg-[#3d4c53]'>Git</a>
